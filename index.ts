...
async function handleUserInfo(answer: boolean) {
    if (answer) {
...
async function handleUserInit(answer: boolean) {
    if (answer) {
        await main();
    } else {
...
async function handleMintSPL(answer: string, spl: any) {
...
async function runMint(mintCode: string) {
    try{
